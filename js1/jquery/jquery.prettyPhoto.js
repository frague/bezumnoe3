...
(function($) {
    ...
    $.fn.prettyPhoto = function(pp_settings) {
        pp_settings = jQuery.extend({
            ...
            custom_markup: '',
            social_tools: '<a href="/gallery{comments_link}">Комментарии</a> {comments}' /* html or false to disable */
        }, pp_settings);
        ...
        */
        $.prettyPhoto.initialize = function() {
            ...
            pp_srcs = (isSet) ? jQuery.map(matchedObjects, function(n, i){ if($(n).attr('rel').indexOf(theRel) != -1) return $(n).attr('src'); }) : $.makeArray($(this).attr('src'));
        ...
        * @param comments {String,Array} Comments information and link components.
        */
        $.prettyPhoto.open = function(event) {
            if(typeof settings == "undefined"){ // Means it's an API call, need to manually get the settings and set the variables
                ...
                pp_srcs = (arguments[3]) ? $.makeArray(arguments[3]) : $.makeArray("");
