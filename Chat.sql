...
--
-- Хост: localhost
-- Время создания: Ноя 27 2010 г., 00:23
...
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 COMMENT='Admin comments to users' AUTO_INCREMENT=8158 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 AUTO_INCREMENT=515 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 AUTO_INCREMENT=137205 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 AUTO_INCREMENT=478 ;
...
CREATE TABLE IF NOT EXISTS `journal_templates` (
  ...
  KEY `UPDATED` (`UPDATED`)
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 AUTO_INCREMENT=324 ;
...
CREATE TABLE IF NOT EXISTS `messages` (
  ...
  KEY `AUTHOR` (`USER_ID`)
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 COMMENT='All chat messages' AUTO_INCREMENT=327837 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 COMMENT='Users alternative names' AUTO_INCREMENT=760 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 COMMENT='Users profiles' AUTO_INCREMENT=7483 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 AUTO_INCREMENT=2451 ;
...
CREATE TABLE IF NOT EXISTS `settings` (
  ...
  UNIQUE KEY `USER_ID` (`USER_ID`)
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 COMMENT='Chat settings' AUTO_INCREMENT=7521 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 COMMENT='Forum/Journal/Gallery records tags (labels)' AUTO_INCREMENT=364 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 COMMENT='Chat users' AUTO_INCREMENT=7521 ;
