...
<h4>Фотография:</h4>
<div id="Photo"></div>
<form name="uploadForm" id="uploadForm" action="/3/services/profile.service.php" method="POST" enctype="multipart/form-data">
...
<h4>Аватар:</h4>
<div id="Avatar"></div>
<form name="avatarUploadForm" id="avatarUploadForm" action="/3/services/profile.service.php" method="POST" enctype="multipart/form-data">
