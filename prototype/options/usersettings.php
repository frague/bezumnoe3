...
<p class="Note">Используйте ключевое слово <b>%name</b> в том месте, куда будет подставлен ваш никнейм</p>
	...
	<tr class="Radios" id="FRAMESET"><td width="25"><img src="/3/img/frames/0.gif" /><input type="radio" id="SET0" name="FRAMESET1" value="0" /><label for="SET0">Список пользователей слева, поле ввода вверху</label></td><td width="25"><img src="/3/img/frames/1.gif" /><input type="radio" id="SET1" name="FRAMESET1" value="1" /><label for="SET1">Список пользователей справа, поле ввода вверху</label></td><td width="25"><img src="/3/img/frames/2.gif" /><input type="radio" id="SET2" name="FRAMESET1" value="2"><label for="SET2" />Список пользователей слева, поле ввода внизу</label></td><td width="25"><img src="/3/img/frames/3.gif" /><input type="radio" id="SET3" name="FRAMESET1" value="3" /><label for="SET3">Список пользователей справа, поле ввода внизу</label></td></tr></table>
