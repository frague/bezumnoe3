...
<p>Если вы у нас впервые, ознакомьтесь с <a href="#">правилами</a> и <a href="/register.php">зарегистрируйтесь</a>. Если вы уже бывали здесь раньше - просто введите свой логин и пароль.
 		</div>
	</div>
