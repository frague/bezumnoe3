<div id="Hider">
	...
	?>
		<span class="Warning">
			Для публикации сообщений и комментариев необходимо <a href="/">авторизоваться</a> в чате.<br />
			Если у вас нет аккаунта в чате, пожалуйста <a href="/register.php">зарегистрируйтесь</a>.
		</span>
