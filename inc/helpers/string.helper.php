<?
	...
	$chars = "абвгдеЄжзийклмнопрстуфхцчшщъыьэю€јЅ¬√ƒ≈®∆«»… ЋћЌќѕ–—“”‘’÷„ЎўЏџ№Ёёя";
	$ascii = array();

	$counting = array();
	$counting["пользователь"] 		= "пользовател€|пользователей";
	$counting["комментарий"] 		= "комментари€|комментариев";
	$counting["новый комментарий"] 	= "новых комментари€|новых комментариев";
	$counting["комната"] 			= "комнаты|комнат";
	$counting["сообщение"] 			= "сообщени€|сообщений";
	$counting["новое"] 				= "новых|новых";
	$counting["новое сообщение"]	= "новых сообщени€|новых сообщений";
	$counting["ответ"] 				= "ответа|ответов";
	$counting["фотографи€"] 		= "фотографии|фотографий";
